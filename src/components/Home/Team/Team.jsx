...
function Team() {
  ...
  return (
    <>
      <Parallax bgImage="/Team/bg4.jpeg" strength={500}>
        <div className="relative">
          <div className="absolute w-full h-full left-0 top-0  bg-black/30 "></div>
          <div
            className={`tablet:container mx-auto relative w-full tablet:p-10  p-2   flex flex-col tablet:gap-10
          ...
          >
            <div className="flex  flex-col  w-full laptop:ml-auto laptop:gap-3 gap-2 items-center z-10 ">
              ...
              >
                ...
                Laborum sint consequuntur adipisci itaque deserunt libero non
                omnis sapiente et suscipit?
              </p>
            </div>
