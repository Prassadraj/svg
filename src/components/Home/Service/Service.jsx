...
function Service() {
  ...
  return (
    <div
      className="relative tablet:bg-[url('/Service/background6.jpeg')] 
    bg-[url('/Service/serviceBgmobile.png')] bg-no-repeat bg-cover bg-center 
      ...
      >
        <div className="flex z-10   flex-col laptop:items-start w-full laptop:mr-auto laptop:gap-3 gap-4 items-center">
          ...
          >
            ...
            optio necessitatibus voluptates amet consectetur, tempora omnis
            rerum
          </p>
        </div>
        <div className="grid !grid-cols-1 tablet:!grid-cols-2 place-items-center gap-10  laptop:gap-0  laptop:!grid-cols-3  justify-evenly relative ">
          ...
          <div
            ...
            className="tablet:w-[300px] w-[200px] tablet:h-[350px] h-[250px]
            cursor-pointer relative rounded-t-full overflow-hidden border-2 border-dotted "
          >
            <Image
              alt="img"
              fill
            ...
            >
              ...
              <div className="absolute bottom-2 z-10  left-2 text-white">
                ...
                <p className={`${montLight.className} tablet:text-sm text-xs`}>
                  Where vision meets craftsmanship to create stunning,
                  functional spaces.
                </p>
              </div>
            </div>
          ...
          <div
            ...
            onMouseLeave={() => setView("")}
            className="  cursor-pointer tablet:w-[300px] w-[200px] tablet:h-[350px] h-[250px] laptop:mt-20 relative rounded-t-full overflow-hidden border-2 border-dotted"
          >
            <Image
              alt="img"
              loading="lazy"
          ...
          <div
            ...
            onMouseLeave={() => setView("")}
            className="  cursor-pointer tablet:w-[300px] w-[200px] tablet:h-[350px] h-[250px] tablet:!col-span-2  laptop:!col-span-1 relative rounded-t-full overflow-hidden border-2 border-dotted "
          >
            <Image
              alt="img"
              fill
